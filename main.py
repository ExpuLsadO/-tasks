...
def main():
    ...
    schedule.every().day.at("23:00").do(req) # для ежедневного обновления
    # schedule.every(3).minutes.do(req) вариант для проверки работоспособности 
...
# было нужно пока изучал туториал
